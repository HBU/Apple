...
//  https://www.cnblogs.com/heyonggang/p/3452817.html
...
- (void)viewDidLoad
{
    ...
    self.label.backgroundColor=[UIColor lightGrayColor];   //设置背景颜色
    ...
    [button0 setTitle:@"0" forState:UIControlStateHighlighted];                //设置button主题
    button0.titleLabel.textColor = [UIColor greenColor];       //设置0键的颜色
    [button0 addTarget:self action:@selector(shuzi:) forControlEvents:UIControlEventTouchUpInside];
    //按下按钮，并且当手指离开离开屏幕的时候触发这个事件
